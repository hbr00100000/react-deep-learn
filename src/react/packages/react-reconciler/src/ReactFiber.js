...
function FiberNode(tag, pendingProps, key, mode) {
  ...
  this.memoizedProps = null; // 存储的props
  this.updateQueue = null; // 存储更新对象链表
  this.memoizedState = null; // 存储hook链表
  this.dependencies = null; // 保存context， 事件相关内容
